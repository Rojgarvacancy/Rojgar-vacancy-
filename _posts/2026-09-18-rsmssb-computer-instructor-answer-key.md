...
<div style="color: #222222; font-family: Arial, Helvetica, sans-serif; line-height: 1.6; margin: 0px auto; max-width: 900px;">
  ...
  <div style="background: rgb(255, 248, 225); border: 1px solid rgb(255, 204, 128); margin-bottom: 15px; padding: 12px 15px;">
    <strong>Short Information :</strong> Rajasthan Staff Selection Board (RSMSSB / RSSB, Jaipur) has officially released the primary <strong>Answer Key</strong> for the recruitment examination of Basic Computer Instructor (BCI) and Senior Computer Instructor (SCI) under Advt No. 07/2026. Candidates who appeared in the written exam can download their Paper-wise Answer Key PDF using the direct links provided below.
  </div>

  <!--Important Dates & Recruitment Details Table-->
  <table style="border-collapse: collapse; font-size: 14px; margin-bottom: 15px; width: 100%;">
    <thead>
      <tr style="background: rgb(21, 101, 192); color: white;">
        <th style="border: 1px solid rgb(144, 202, 249); padding: 8px; width: 50%; text-align: left;">Important Details</th>
        <th style="border: 1px solid rgb(144, 202, 249); padding: 8px; width: 50%; text-align: left;">Post Details</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td style="border: 1px solid rgb(144, 202, 249); padding: 8px; vertical-align: top;">
          • Recruitment Board : <strong>RSMSSB / RSSB Jaipur</strong><br>
          • Advertisement No. : <strong>07/2026</strong><br>
          • Exam Date : <strong>As per Schedule</strong><br>
          • Answer Key Status : <span style="color: red; font-weight: bold;">Available Now</span>
        </td>
        <td style="border: 1px solid rgb(144, 202, 249); padding: 8px; vertical-align: top;">
  ...
  <h3 style="background: rgb(21, 101, 192); color: white; font-size: 16px; margin: 0px; padding: 8px 12px;">How to Check RSMSSB Computer Instructor Answer Key</h3>
  <div style="background: #ffffff; border: 1px solid rgb(144, 202, 249); margin-bottom: 15px; padding: 10px 15px; font-size: 14px;">
    • Look for your respective post (Basic Computer Instructor or Senior Computer Instructor) and paper code below.<br>
    • Click on the direct PDF download link for Paper I or Paper II.<br>
    • Match your answers with the official master answer key released by the board.<br>
    • If candidates have any objections, they may submit their representations through the official SSO Rajasthan portal within the given objection window.
  </div>
  ...
  <table style="border-collapse: collapse; font-size: 14px; margin-bottom: 20px; width: 100%;">
    <tbody>
      ...
      <tr>
        <td style="border: 1px solid rgb(239, 154, 154); padding: 10px;"><strong>Download BCI Paper II (Code PQQ)</strong></td>
        <td style="border: 1px solid rgb(239, 154, 154); padding: 10px; text-align: center;">
          <a href="https://rssb.rajasthan.gov.in/storage/answerkey_item/1789713403.pdf" target="_blank" rel="noopener noreferrer" style="background: rgb(46, 125, 50); border-radius: 4px; color: white; font-weight: bold; padding: 6px 14px; text-decoration: none; display: inline-block;">Click Here</a>
        </td>
      </tr>
      <tr style="background: rgb(255, 235, 238);">
        <td style="border: 1px solid rgb(239, 154, 154); padding: 10px;"><strong>Download SCI Paper I (Code 25RK)</strong></td>
        <td style="border: 1px solid rgb(239, 154, 154); padding: 10px; text-align: center;">
          <a href="https://rssb.rajasthan.gov.in/storage/answerkey_item/1789713448.pdf" target="_blank" rel="noopener noreferrer" style="background: rgb(21, 101, 192); border-radius: 4px; color: white; font-weight: bold; padding: 6px 14px; text-decoration: none; display: inline-block;">Click Here</a>
        </td>
      </tr>
      <tr>
        <td style="border: 1px solid rgb(239, 154, 154); padding: 10px;"><strong>Download SCI Paper II (Code DU15)</strong></td>
        <td style="border: 1px solid rgb(239, 154, 154); padding: 10px; text-align: center;">
          <a href="https://rssb.rajasthan.gov.in/storage/answerkey_item/1789713490.pdf" target="_blank" rel="noopener noreferrer" style="background: rgb(21, 101, 192); border-radius: 4px; color: white; font-weight: bold; padding: 6px 14px; text-decoration: none; display: inline-block;">Click Here</a>
        </td>
      </tr>
      <tr style="background: rgb(255, 235, 238);">
      ...
      <tr>
        ...
        <td style="border: 1px solid rgb(239, 154, 154); padding: 10px; text-align: center;">
          <a href="https://rssb.rajasthan.gov.in/" target="_blank" rel="noopener noreferrer" style="background: rgb(239, 108, 0); border-radius: 4px; color: white; font-weight: bold; padding: 6px 14px; text-decoration: none; display: inline-block;">Click Here</a>
        </td>
      </tr>
      <tr style="background: rgb(255, 235, 238);">
